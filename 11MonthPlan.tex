...
\hline
     ...
     \hline
     Implementing existing & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & & & & & & & &  \cellcolor{lighterblue}\\
    physical models & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & \cellcolor{green} & & & & & & & &  \cellcolor{lighterblue}\\
     \hline
    ...
    framework  & & & & & & & \cellcolor{lighterred} & \cellcolor{lighterred} & \cellcolor{lighterred} &\cellcolor{lighterred} &\cellcolor{lighterred} &  \cellcolor{lighterblue}\\
     ...
     \\
     \hline 
      Writing conference /  & & \cellcolor{green} &\cellcolor{green}  & \cellcolor{green} & \cellcolor{yellow} & & & & & & &
      \cellcolor{lighterblue}\\
