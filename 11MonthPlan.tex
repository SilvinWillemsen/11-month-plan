...
\vspace{0.15cm}
\\
\SWcomment[C2\textonehalf. S. Willemsen, S. Bilbao and S. Serafin, ``Necessary and sufficient conditions for the elasto-plastic friction model,'' \textit{SOMEWHERE}, 2019.]
\vspace{0.15cm}
\\
...
\bf Virtual, Augemented, & AAU / Stefania Serafin & 5 & Project & Enrolled\\ \bf 
 ...
 (Malaga, Helsinki, etc.) & & & &\\ 
 \rowcolor{lightestblue} \bf \SWcomment[Research Seminar(s) on energy] & Uni. of Edinburgh / &  1.25 & Project & Finished \\ 
\rowcolor{lightestblue} \bf \SWcomment[and stability analysis] & Stefan Bilbao & & &\\
& \bf Total & 30 & & \\
    \hline
\end{tabular}
