...
As mentioned before, PMs relieve some of the physical limitations that the real world imposes on real-life instruments. \SWcomment[$\Leftarrow$ different wording] I believe there are to ways to do this: 
\begin{enumerate}
